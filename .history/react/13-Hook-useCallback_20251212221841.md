...
개발자 도구에서 `Profiler`를 사용하여 선능 테스트를 할 수 있다.

![profiler-1](../src/images/profiler-1.png)

- `profiling` 시작 버튼을 클릭한 후에 동작 변화에 따른 리렌더링 작업이 진행되고 정지 버튼을 누르면, 페이지네이션 별로 기록을 볼 수 있다.

<br />

### 메모이제이션 되기 전

![profiler-2](../src/images/profiler-2.png)

- 총 3가지 동작을 하였고 3번 리렌더링이 발생하였다.

<br />

### 메모이제이션 된 후

![profiler-3](../src/images/profiler-3.png)

- 동작과 리렌더링은 동일하다.

- 하지만 메모에제이션이 되어 동작하는 아이템만 리렌더링이 발생하게되어,

  - 렌더링 되는 시간이 현저히 감소한걸 볼 수 있다.