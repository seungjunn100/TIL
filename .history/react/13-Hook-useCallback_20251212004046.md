...
- [useMemo, React.memo, useCallback 차이점](#usememo-reactmemo-usecallback-차이점)
...
- 함수를 인자로 전달받고, 전달된 함수의 실행 결과(리턴값)를 메모이제이션

### `React.memo`

- 컴포넌트를 인자로 전달받고, 전달된 컴포넌트를 메모이제이션

### `useCallback`

- 함수를 인자로 전달받고, 전달된 함수를 메모이제이션